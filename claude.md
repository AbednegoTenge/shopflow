...
Not yet re-run since the fix — next step is re-running the failed workflow (no new push needed, the app-side change was already correct) to confirm the deploy path actually completes end to end.
